...
public class Desafio1 {
    ...
    private final Janela janela = new Janela("Lost Soul 1.0 - Salomão Silva");
    ...
    private void carregaPersonagens() {
        ...
        personagem1.setPersonagem("imagens/1.png", 64, 64);

        // personsagem
        Personagem2 personagem2 = new Personagem2();
        personagem2.setPersonagem("imagens/2.png", 64, 64);

        // personsagem
        Personagem3 personagem3 = new Personagem3();
        personagem3.setPersonagem("imagens/3.png", 64, 64);

        // personsagem
        Personagem4 personagem4 = new Personagem4();
        personagem4.setPersonagem("imagens/4.png", 64, 64);
    ...
    public void rodar() {
        ...
        Som som = new Som();
        som.Play("/sons/somjogo.wav", true);
